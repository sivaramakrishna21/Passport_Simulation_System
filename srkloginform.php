<?php
	if(isset($_POST['Submit'])){
		...
		$sql="SELECT * from `registrationspp` where email='$email' and password='$password'";
		$result=mysqli_query($con,$sql);
		if($result->num_rows>0)
		{
			$sql1="insert into logtable values('$email','$password')";
			$con->query($sql1);
			header('Location:http://localhost/Passport%20Simulation/pro1.html');
			exit();
		}
		else
		{
...
<body>
<div class="navbar">
  <a href="http://localhost/Passport%20Simulation/pass2.php">Home</a>
  <a href="http://localhost/Passport%20Simulation/srkloginform.php">login</a>
...
<div class="row">
  <div class="left" style="background-color:navy;">
    ...
    <ul id="myMenu">
      ...
      <li><a href="http://localhost/Passport%20Simulation/srkloginform.php">Appointment Status</a></li>
