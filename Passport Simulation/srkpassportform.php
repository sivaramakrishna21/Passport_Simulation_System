	...
	if(isset($_POST['Submit'])){
		...
		else 
		{
			...
			if($result->num_rows>0)
			{
				...
				$_SESSION['app']=$appid;
				$sql1="insert into passportform values('$firstname','$lastname','$gender','$aadhar','$birthvillage','$select','$state','$district','$education','$employment','$email','$phone','$appid','$loginid')";
				if ($con->query($sql1) === TRUE) {
					$sql2="insert into appstatus values('$appid',0,0,0,0)";
			...
			{
				$message = "you need to register before applying for passport";
				echo "<script type='text/javascript'>alert('$message');</script>";
				return false;
			}
		}
...
<input type="text" id="loginid" name="loginid" required/></br><br><br>
